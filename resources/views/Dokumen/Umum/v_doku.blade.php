...
@section('bread', '/ Dokumen Umum')
@section('konten')

    <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title">Dokumen Umum
        </h6>
        <br>
        <form method="GET" action="{{ route('arsip.filter') }}">
            <div class="row ml-20">
                <div class="col-md-3">
                ...
                <div class="col-md-2 btn-group" role="group" aria-label="Basic example">
                    ...
                    <a href="{{ route('doku.index') }}" class="btn btn-success"><i
                            class="fa fa-refresh"></i>&nbsp;Refresh</a>
                    <a href="{{ route('doku.create') }}" class="btn btn-info " style="float: right;"><i
                            class="fa fa-plus"></i>
                        Tambah
                        Dokumen</a>
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="{{ route('doku.show', $item->id) }}" class="btn btn-primary dropdown-item"
                                        target="_blank">Lihat File</a>
                                    <a href="{{ route('doku.detail', $item->id) }}"
                                        class="btn btn-primary dropdown-item">Detail</a>
                                    @if (auth()->user()->hak == 1)
                                        <a href="{{ route('doku.edit', $item->id) }}"
                                            class="btn btn-primary dropdown-item" target="_blank">Ubah</a>
