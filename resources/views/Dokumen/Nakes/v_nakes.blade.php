...
@section('bread', '/ Dokumen Nakes')
@section('konten')

    <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title">Dokumen Nakes
        </h6>
        <br>
        <form method="GET" action="{{ route('nakes.filter') }}">
            <div class="row ml-20">
                <div class="col-md-3">
                ...
                <div class="col-md-2 btn-group" role="group" aria-label="Basic example">
                    ...
                    <a href="{{ route('nakes.index') }}" class="btn btn-success"><i
                            class="fa fa-refresh"></i>&nbsp;Refresh</a>
                    <a href="{{ route('nakes.create') }}" class="btn btn-info " style="float: right;"><i
                            class="fa fa-plus"></i>
                        Tambah
                        Dokumen</a>
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="{{ route('nakes.show', Crypt::encrypt($item->id)) }}"
                                        class="btn btn-primary dropdown-item" target="_blank">Lihat File</a>
                                    <a href="{{ route('nakes.detail', Crypt::encrypt($item->id)) }}"
                                        class="btn btn-primary dropdown-item">Detail</a>
                                    <a href="{{ route('nakes.edit', Crypt::encrypt($item->id)) }}"
